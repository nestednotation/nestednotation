 ...
 * later absorbed by a merge. A merge-ABSORBED line is not kept (2026-09-06):
 * its number goes back in the pool the moment the rejoin runs, and its merge
 * undo RE-CREATES it from the snapshot instead of holding the object — which
 * is what lets a merge stay undoable for the rest of the session without the
